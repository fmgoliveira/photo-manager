...
<div
  class="max-h-screen w-[500px] max-w-[95vw] overflow-y-scroll rounded-xl border bg-immich-bg p-4 py-8 shadow-sm dark:border-immich-dark-gray dark:bg-immich-dark-gray dark:text-immich-dark-fg"
>
